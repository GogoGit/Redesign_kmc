...
const key = "oPLG8YzOchvb5TKZ1nBt4wGD4EpD2NcB";
...
function showData(stories) {
  ...
  setWithExpiry(storagePrefix, looped, 1000 * 60 * 60);  //time in Javascript is miliseconds ... so 1 second * 1 minute
}
...
//     // 2 Ternary Expression (used in template strings)
//     //    story.multimedia ? story.multimedia[2].url : ""
//     //    story.multimedia ? story.multimedia[2]?.caption : ""
//     <img src="${story.multimedia ? story.multimedia[2].url : ""}" alt="${
//         story.multimedia ? story.multimedia[2]?.caption : ""
//       }" />
